    ...
    <div>
      ...
      <div className="rounded-2xl p-8" style={{ background: '#fff', border: '1.5px solid #E5E7EB', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
        ...
        <p style={{ fontSize: '0.875rem', color: '#6B7280', marginBottom: 24 }}>
          Inicia sesión para ver tus pedidos y personalizar productos.
        </p>
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span style={{ fontSize: '0.75rem', color: '#9CA3AF', fontWeight: 500 }}>o continúa con email</span>
          <div style={{ flex: 1, height: 1, background: '#E5E7EB' }} />
        </div>
        ...
        <form action={formAction} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" style={{ fontSize: '0.75rem', color: '#EC3A12', fontWeight: 600 }}>
                ¿Olvidaste tu contraseña?
              </Link>
            </div>
            <input name="password" type="password" required autoComplete="current-password" placeholder="••••••••" className={IC} style={IS} />
          </div>
          ...
          <SubmitButton label="Iniciar sesión" loadingLabel="Entrando…" className="btn-primary w-full justify-center py-3 mt-1" />
        </form>

        <p className="mt-6 text-center text-sm" style={{ color: '#6B7280' }}>
          ¿No tienes cuenta?{' '}
          <Link href="/register" style={{ color: '#EC3A12', fontWeight: 700 }}>Regístrate gratis</Link>
        </p>
      </div>
    </div>
  )
